// Package astkratos debug utilities: Debug mode control and logging functions
...
// Designed for clean production output while maintaining detailed debugging support
//
